...
### 5. Add mean BMIz scores for ages 8:13; 9:15; 12:17

```{r}
# Define a list of age pairs (first age, second age)
age_pairs <- list(c(8, 13), c(10, 15), c(12, 17))
...
mbmiz_data <- BMIZ_8_13 %>%
  left_join(BMIZ_10_15, by = "id") %>%
  left_join(BMIZ_12_17, by = "id") 
```
...
BMI_bestavail_wide <- full_join(BMI_bestavail_wide, mbmiz_data) |> 
  mutate(bmiz_drop_raw.168 = mbmiz_8_13 - `bmiz_bestavail.168`, 
         bmiz_drop.168 = case_when(bmiz_drop_raw.168 > .5 ~ 1,
                                   bmiz_drop_raw.168 < .5 ~ 0 ),
         bmiz_drop_raw.192 = mbmiz_10_15 - `bmiz_bestavail.192`, 
         bmiz_drop.192 = case_when(bmiz_drop_raw.192 > .5 ~ 1,
                                   bmiz_drop_raw.192 < .5 ~ 0 ),
         bmiz_drop_raw.216 = mbmiz_12_17 - `bmiz_bestavail.216`, 
